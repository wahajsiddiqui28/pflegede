                    ...
                    <ul class="pf-source-list">
                        <li class="pf-source-item">
                            ...
                            <div>
                                ...
                                <p class="pf-source-item__desc">z. B. Bundesministerium für Gesundheit (BMG) und vergleichbare amtliche Quellen.</p>
                            </div>
                        </li>
                        <li class="pf-source-item">
                        ...
                        <li class="pf-source-item">
                            ...
                            <div>
                                <div class="pf-source-item__title">Wissenschaftliche und fachliche Quellen</div>
